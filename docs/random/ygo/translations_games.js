export const gameTranslations = {
    ...
    "yu-gi-oh": [
        ...
        ["common", "Common", "C"],
        ["rare", "Rare", "R"],
        ["parallelrare", "Parallel Rare", "P"],
        ["superrare", "Super Rare", "SR"],
        ["ultrarare", "Ultra Rare", "UR"],
        ["ultraparallelrare", "— Ultra Parallel Rare", "— UPR"],
        ["goldrare", "Gold Rare", "GR"],
        ["premiumgoldrare", "Premium Gold Rare", "PGR"],
        ["secretrare", "Secret Rare", "SE"],
        ["goldsecretrare", "— Gold Secret Rare", "— GSR"],
        ["platinumsecretrare", "— Platinum Secret Rare", "— PSE"],
        ["prismaticsecretrare", "— Prismatic Secret Rare", "— PRSE"],
        ["quartercenturysecretrare", "— Quarter Century Secret Rare", "— QCR"],
        ["collectorsrare", "Collector's Rare", "CR"],
        ["prismaticcollectorsrare", "— Prismatic Collector's Rare", "— PCR"],
        ["ultimaterare", "Ultimate Rare", "UL"],
        ["prismaticultimaterare", "— Prismatic Ultimate Rare", "— PUL"],
        ["ghostrare", "Ghost Rare", "GH"],
        ["starlightrare", "Starlight Rare", "ST"],
        ["fake", "FAKE", "FALSA"],
